...
<div class="container mt-5">
    ...
    <div class="row justify-content-center mb-5">
        <div class="col-lg-6 shadow-sm p-3 mb-5 bg-body-tertiary rounded">
            <form action="/ktm/save" method="POST" enctype="multipart/form-data">
                <?= csrf_field(); ?>
                <div class="mb-3">
                ...
                <img src="<?= base_url('img/default.jpg'); ?>" class="img-preview img-thumbnail my-2" width="120px">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control <?= (session('errors.nim')) ? 'is-invalid' : '' ?>" id="nim" name="nim" placeholder="Nomor Induk Mahasiswa" value="<?= old('nim'); ?>">
                    <div class="invalid-feedback">
                        <?= session('errors.nim'); ?>
                    </div>
                </div>
